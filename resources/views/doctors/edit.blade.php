...
<div style="display:flex;align-items:center;gap:10px;margin-bottom:20px;">
    ...
    <span style="font-size:13px;font-weight:600;">Edit: Dr. {{ $doctor->name }}</span>
</div>
...
<form action="{{ route('doctors.update', $doctor) }}" method="POST">
    ...
    <div class="form-card">
        <div class="form-section-title"><i class="fa-solid fa-user-doctor"></i> Update Information</div>
        <div class="form-body">
            <div class="form-row">
                <div class="form-group">
                    <label>Full Name *</label>
                    <input type="text" name="name" placeholder="Dr. John Doe" required value="{{ old('name', $doctor->name) }}">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="designation" placeholder="e.g. Senior Consultant" value="{{ old('designation', $doctor->designation) }}">
                </div>
                <div class="form-group">
                    <label>Phone Number</label>
                    <input type="text" name="phone" placeholder="+92 ..." value="{{ old('phone', $doctor->phone) }}">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="form-body">
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="specialization" placeholder="e.g. Cardiology" required value="{{ old('specialization', $doctor->specialization) }}">
                </div>
                <div class="form-group">
                    <label>Qualification</label>
                    <input type="text" name="qualification" placeholder="e.g. MBBS, FCPS" value="{{ old('qualification', $doctor->qualification) }}">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label>Consultation Fee (Rs.) *</label>
                    <input type="number" name="fee" required value="{{ old('fee', $doctor->fee) }}">
                </div>
                <div class="form-group">
